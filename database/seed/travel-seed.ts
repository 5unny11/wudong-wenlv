...
export async function seedTravelData(dataSource: DataSource) {
  ...
  // 景区
  const spots = await scenicRepo.save([
  ...
  await ticketRepo.save([
    { scenic_spot_id: spot1.id, name: "成人票", price: 80, stock: 1000, valid_days: 3 },
    { scenic_spot_id: spot1.id, name: "儿童票", price: 40, stock: 500, valid_days: 3 },
    { scenic_spot_id: spot1.id, name: "家庭套票（2大1小）", price: 160, stock: 200, valid_days: 3 },
    { scenic_spot_id: spot1.id, name: "学生票", price: 50, stock: 300, valid_days: 3 },
    { scenic_spot_id: spot2.id, name: "成人票", price: 30, stock: 500, valid_days: 1 },
    { scenic_spot_id: spot2.id, name: "儿童票", price: 15, stock: 300, valid_days: 1 },
    { scenic_spot_id: spot3.id, name: "全价票", price: 20, stock: 9999, valid_days: 1 },
  ]);
  ...
  // 路线行程（使用返回的实际 route ID）
  await scheduleRepo.save([
    { route_id: route1.id, day_number: 1, description: "上午抵达乌东村，参观苗族文化博物馆，前往银饰坊观摩银饰锻造。", attractions: "博物馆、银饰坊", meals: "午餐：苗家长桌宴", transport: "凯里高铁站接站" },
    { route_id: route2.id, day_number: 1, description: "抵达后参观博物馆和银饰坊，享用长桌宴，入住特色民宿，参加篝火晚会。", attractions: "博物馆、银饰坊、篝火晚会", meals: "晚餐：长桌宴", accommodation: "苗寨特色民宿", transport: "接站" },
    { route_id: route2.id, day_number: 2, description: "清晨梯田观日出，体验蜡染制作，苗寨徒步后返程。", attractions: "梯田、蜡染工坊", meals: "早餐+午餐", transport: "送站" },
    { route_id: route3.id, day_number: 1, description: "传承人讲授苗族文化，观摩银饰锻造，亲手制作蜡染作品。", attractions: "文化讲堂、蜡染教室", meals: "午餐：苗家菜" },
    { route_id: route4.id, day_number: 1, description: "亲子互动游戏+银饰手镯DIY+长桌宴+篝火晚会。", attractions: "亲子活动区", meals: "晚餐：长桌宴", accommodation: "民宿" },
    { route_id: route4.id, day_number: 2, description: "农田劳作体验+糍粑制作，午餐后返程。", attractions: "农田、糍粑工坊", meals: "早餐+午餐" },
  ]);
